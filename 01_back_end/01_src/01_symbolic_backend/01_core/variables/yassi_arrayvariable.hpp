 ...
 */
#ifndef YASSI_ARRAYVARIABLE_HPP
#define YASSI_ARRAYVARIABLE_HPP
...
/**
 * @class ArrayVariable
 * @brief ArrayVariable for Symbolic Execution
 */
...
private:
    ...
    ArrayVariable(Yassi::Types::BaseType* type,
