 ...
 */
#ifndef YASSI_VOIDVARIABLE_HPP
#define YASSI_VOIDVARIABLE_HPP
...
class VoidVariable: public BaseVariable {
public:
    virtual ~VoidVariable();
...
private:
    ...
    VoidVariable(Yassi::Types::BaseType* type,
