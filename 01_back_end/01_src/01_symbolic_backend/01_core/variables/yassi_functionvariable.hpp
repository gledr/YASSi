/** 
 * @file yassi_functionvariable.hpp
 ...
 */
#ifndef YASSI_FUNCTIONVARIABLE_HPP
#define YASSI_FUNCTIONVARIABLE_HPP
 ...
 * @brief Function Variable Type for Symbolic Execution
 */
class FunctionVariable: public BaseVariable {
public:
...
private:
    ...
    FunctionVariable(Yassi::Types::BaseType* type,
...
#endif /* YASSI_FUNCTIONVARIABLE_HPP */
