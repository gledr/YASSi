 ...
 */
#ifndef YASSI_STRUCTVARIABLE_HPP
#define YASSI_STRUCTVARIABLE_HPP
 ...
 * @brief Struct Variable Type for Symbolic Execution
 */
class StructVariable: public BaseVariable {
public:
...
private:
    ...
    StructVariable(Yassi::Types::BaseType* type,
...
#endif /* YASSI_STRUCTVARIABLE_HPP */
