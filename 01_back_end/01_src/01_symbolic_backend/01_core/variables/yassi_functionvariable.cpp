/** 
 * @file yassi_functionvariable.cpp
 * @brief Function Variable Type for Symbolic Execution
 * 
 ...
 */
FunctionVariable::FunctionVariable(BaseType* type,
 ...
 * @return z3::expr
 */
z3::expr FunctionVariable::get_formula_to_evaluate() 
{
    notsupported_check("Function Types not supported by LLVM. Should never be called!");
    exit(-1);
}
 ...
 * @return z3::expr
 */
z3::expr FunctionVariable::get_smt_formula() 
{
    notsupported_check("FunctionVariable must not command over a SAT instance");
    exit(-1);
}
 ...
 */
void FunctionVariable::set_pointer(BaseVariable* dst) 
{
    nullpointer_check(dst);
    notsupported_check("FunctionType is no pointer!");
}
 ...
 */
BaseVariable* FunctionVariable::get_pointer() 
{
    notsupported_check("FunctionType is no pointer!");
    exit(-1);
}
 ...
 */
void FunctionVariable::dump(std::ostream & stream) 
{
