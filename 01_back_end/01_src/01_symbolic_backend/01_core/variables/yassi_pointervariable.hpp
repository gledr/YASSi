/** 
 * @file yassi_pointervariable.hpp
 ...
 */
#ifndef YASSI_POINTERVARIABLE_HPP
#define YASSI_POINTERVARIABLE_HPP
 ...
 * @brief Pointer Variable Type for Symbolic Execution
 */
class PointerVariable: public BaseVariable {
public:
...
private:
    ...
    PointerVariable(Yassi::Types::BaseType* type,
...
#endif /* YASSI_POINTERVARIABLE_HPP */
