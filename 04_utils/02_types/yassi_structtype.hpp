 ...
 * 51 
 */
#ifndef YASSI_STRUCT_TYPE_HPP
#define YASSI_STRUCT_TYPE_HPP
...
/**
 * @class StructType
 * @brief Type for Structs used in Yassi
 * 
 * StructType is used in the Yassi Backend as well
